...
def _load_scoring_config(windows: "WindowConfig") -> "ScoringConfig":
    ...
    return ScoringConfig(
        ...
        robustness_score_center_warn_units=_env_float("MACD_V2_ROBUSTNESS_SCORE_CENTER_WARN_UNITS", 2.0),
        robustness_score_center_fail_units=_env_float("MACD_V2_ROBUSTNESS_SCORE_CENTER_FAIL_UNITS", 4.0),
        robustness_score_center_extreme_units=_env_float("MACD_V2_ROBUSTNESS_SCORE_CENTER_EXTREME_UNITS", 8.0),
        robustness_score_center_penalty_max=_env_float("MACD_V2_ROBUSTNESS_SCORE_CENTER_PENALTY_MAX", 0.05),
        robustness_score_spread_warn_ratio=_env_float("MACD_V2_ROBUSTNESS_SCORE_SPREAD_WARN_RATIO", 3.0),
        robustness_score_spread_fail_ratio=_env_float("MACD_V2_ROBUSTNESS_SCORE_SPREAD_FAIL_RATIO", 6.0),
        robustness_score_spread_extreme_ratio=_env_float("MACD_V2_ROBUSTNESS_SCORE_SPREAD_EXTREME_RATIO", 10.0),
        robustness_score_spread_penalty_max=_env_float("MACD_V2_ROBUSTNESS_SCORE_SPREAD_PENALTY_MAX", 0.03),
        robustness_score_envelope_multiplier=_env_float("MACD_V2_ROBUSTNESS_SCORE_ENVELOPE_MULTIPLIER", 4.0),
        robustness_score_envelope_fail_units=_env_float("MACD_V2_ROBUSTNESS_SCORE_ENVELOPE_FAIL_UNITS", 2.0),
        robustness_score_envelope_extreme_units=_env_float("MACD_V2_ROBUSTNESS_SCORE_ENVELOPE_EXTREME_UNITS", 5.0),
        robustness_score_envelope_penalty_max=_env_float("MACD_V2_ROBUSTNESS_SCORE_ENVELOPE_PENALTY_MAX", 0.03),
        robustness_ulcer_warn_ratio=_env_float("MACD_V2_ROBUSTNESS_ULCER_WARN_RATIO", 3.0),
        robustness_ulcer_fail_ratio=_env_float("MACD_V2_ROBUSTNESS_ULCER_FAIL_RATIO", 6.0),
        robustness_ulcer_extreme_ratio=_env_float("MACD_V2_ROBUSTNESS_ULCER_EXTREME_RATIO", 10.0),
        robustness_ulcer_penalty_max=_env_float("MACD_V2_ROBUSTNESS_ULCER_PENALTY_MAX", 0.04),
...
class ScoringConfig:
    ...
    robustness_score_center_warn_units: float = 2.0
    robustness_score_center_fail_units: float = 4.0
    robustness_score_center_extreme_units: float = 8.0
    robustness_score_center_penalty_max: float = 0.05
    robustness_score_spread_warn_ratio: float = 3.0
    robustness_score_spread_fail_ratio: float = 6.0
    robustness_score_spread_extreme_ratio: float = 10.0
    robustness_score_spread_penalty_max: float = 0.03
    robustness_score_envelope_multiplier: float = 4.0
    robustness_score_envelope_fail_units: float = 2.0
    robustness_score_envelope_extreme_units: float = 5.0
    robustness_score_envelope_penalty_max: float = 0.03
    robustness_ulcer_warn_ratio: float = 3.0
    robustness_ulcer_fail_ratio: float = 6.0
    robustness_ulcer_extreme_ratio: float = 10.0
    robustness_ulcer_penalty_max: float = 0.04
