    ...
    *,
    ...
    score_components = {
        ...
        for key in (
            ...
            "period_capture_weak_weight",
            "side_capture_weak_weight",
            "train_timed_return_score",
            "validation_timed_return_score",
            "timed_return_score",
            "return_score",
            "train_holding_time_score",
            "validation_holding_time_score",
            "holding_time_score",
            "holding_time_bonus_score",
            "holding_time_underexposure_penalty_score",
            "holding_time_overexposure_penalty_score",
            "promotion_main_contribution",
            "promotion_penalty_total",
            "train_drawdown_risk_score",
            "validation_drawdown_risk_score",
            "drawdown_risk_score",
            "drawdown_risk_allowance_score",
            "drawdown_risk_excess_score",
            "drawdown_risk_severe_excess_score",
