...
class ResearchRuntimeConfigTest(unittest.TestCase):
    def test_load_research_runtime_config_reads_robustness_overrides_from_env_file(self) -> None:
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            self.assertAlmostEqual(runtime.scoring.promotion_drawdown_allowance_base, 0.20)
            self.assertAlmostEqual(runtime.scoring.promotion_drawdown_allowance_activity_bonus, 0.30)
            self.assertAlmostEqual(runtime.scoring.promotion_drawdown_base_weight, 0.10)
            self.assertAlmostEqual(runtime.scoring.promotion_drawdown_knee, 1.25)
            self.assertAlmostEqual(runtime.scoring.promotion_drawdown_excess_weight, 1.00)
